...
export default function Home() {
  return (
    <Flex flexDirection={"column"} minH={"100vh"} width={"95%"} mx={"auto"}>
      <Navbar />
      <Flex
        width={"90%"}
      ...
      >
        ...
        >
          <Text
            ...
            fontWeight={700}
            lineHeight={1.2}
            bgGradient={"radial-gradient(circle, #ff2024, #ff650f)"}
            bgClip={"text"}
            fill={"transparent"}
          >
            Build a polished CV with ease
          </Text>
          <Text
            fontSize={{
              base: "16px",
            ...
            lineHeight={1.5}
          >
            Experience the incredible, free, and open-source CV builder!
          </Text>
          ...
          <Text>Instant access, no registration needed</Text>
        </VStack>
        ...
        >
          ...
          >
            <path
              d="m355.412 5.872-23.068 12.586-284.208 155.07-23.069 12.587a48.18 48.18 0 0 0-19.195 65.296l211.643 387.894a48.18 48.18 0 0 0 65.296 19.195l.06-.032L613.096 478.29l.06-.033a48.18 48.18 0 0 0 19.196-65.296L420.708 25.068a48.18 48.18 0 0 0-65.296-19.196Z"
              fill="#f2f2f2"
            />
            <path
              d="m362.048 18.033-27.323 14.908-275.7 150.428-27.322 14.908a34.31 34.31 0 0 0-13.67 46.499l211.644 387.893a34.31 34.31 0 0 0 46.498 13.67l.06-.033L606.46 466.128l.06-.033a34.31 34.31 0 0 0 13.669-46.498L408.547 31.703a34.31 34.31 0 0 0-46.499-13.67Z"
              fill="#fff"
            />
            <path
            ...
            <path
              d="M705.75 165.702H329.43a48.18 48.18 0 0 0-48.125 48.125v441.876a48.18 48.18 0 0 0 48.125 48.125H705.75a48.18 48.18 0 0 0 48.125-48.125V213.827a48.18 48.18 0 0 0-48.125-48.125Z"
              fill="#e6e6e6"
            />
            <path
              d="M705.75 179.556H329.431a34.31 34.31 0 0 0-34.27 34.271v441.876a34.31 34.31 0 0 0 34.27 34.271h376.32a34.31 34.31 0 0 0 34.27-34.27V213.826a34.31 34.31 0 0 0-34.27-34.27Z"
              fill="#fff"
            />
            <path d="M652.08 287.432H511.78a8.014 8.014 0 0 1 0-16.029H652.08a8.014 8.014 0 1 1 0 16.029ZM685.139 314.48h-173.36a8.014 8.014 0 1 1 0-16.029h173.36a8.014 8.014 0 0 1 0 16.028Z" />
            <path
              d="M480.73 238.625H351.38a3.84 3.84 0 0 0-3.84 3.84v100.95a3.84 3.84 0 0 0 3.84 3.84h129.35a3.84 3.84 0 0 0 3.84-3.84v-100.95a3.84 3.84 0 0 0-3.84-3.84Z"
              fill="#e6e6e6"
            />
            <path
              d="M386.861 300.615a34.087 34.087 0 0 1-8.804 23.076c-5.656 6.207-14.076 10.324-22.573 8.62-7.824-1.568-14.182-8.406-13.389-16.679a12.356 12.356 0 0 1 15.267-11.095c7.433 1.929 10.394 12.641 4.2 17.669-1.486 1.207-3.62-.904-2.12-2.121 4.094-3.324 2.829-10.596-2.113-12.42-5.754-2.122-11.85 2.444-12.264 8.326-.49 6.975 4.852 12.227 11.404 13.463 7.088 1.338 14.116-2.29 18.918-7.297a30.955 30.955 0 0 0 8.474-21.542 1.5 1.5 0 0 1 3 0Z"
              fill="#2f2e41"
            />
            <circle cx="416.155" cy="266.167" r="53.519" />
            <path
            ...
            <path
              ...
              fill="#e6e6e6"
            />
            <circle cx="386.25" cy="420.614" r="34" fill="#e6e6e6" />
            <circle cx="386.25" cy="518.614" r="34" fill="#e6e6e6" />
            <path
              d="M651.87 610.62H461.567a8.014 8.014 0 1 1 0-16.03h190.301a8.014 8.014 0 1 1 0 16.03ZM684.928 637.667h-223.36a8.014 8.014 0 1 1 0-16.028h223.36a8.014 8.014 0 1 1 0 16.028Z"
              fill="#e6e6e6"
            />
            <circle cx="386.25" cy="616.614" r="34" fill="#e6e6e6" />
          </svg>
        </Box>
      </Flex>
      <Footer />
